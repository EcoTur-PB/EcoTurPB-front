export const translations = {
  pt: {
    ...
    home: {
      ...
      sustainableActivitiesDesc: "Descubra atividades que promovem a conservação ambiental.",
      viewActivities: "Ver Atividades",
      sustainableAccommodations: "Hospedagens Sustentáveis",
      sustainableAccommodationsDesc: "Descubra hospedagens que praticam turismo responsável e sustentável.",
      viewAccommodations: "Ver Hospedagens",
      sustainableRestaurants: "Restaurantes Sustentáveis",
      sustainableRestaurantsDesc: "Descubra restaurantes que utilizam ingredientes locais e sustentáveis.",
  ...
  en: {
    ...
    home: {
      ...
      sustainableServicesDesc: "Get to know sustainable restaurants, accommodations, and tourism services, with discounts based on accumulated points",
      ...
      sustainableAccommodationsDesc: "Get to know accommodations that practice responsible and sustainable tourism.",
      viewAccommodations: "View Accommodations",
      sustainableRestaurants: "Sustainable Restaurants",
      sustainableRestaurantsDesc: "Get to know restaurants that use local and sustainable ingredients.",
